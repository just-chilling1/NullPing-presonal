  ...
  return (
    <div className="page-container max-w-3xl pb-36 lg:pb-28">
      ...
      <form onSubmit={handleSubmit} className="mt-6 flex flex-col gap-6">
        ...
        <div className="fixed inset-x-0 bottom-0 z-30 border-t border-border-dim bg-[color-mix(in_srgb,var(--np-surface)_92%,transparent)] px-4 py-3 backdrop-blur-md sm:px-6">
